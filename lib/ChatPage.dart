...
// import 'package:cookingai/pkgs/google_generative_ai/lib/google_generative_ai.dart';



const String _apiKey = 'AIzaSyAMXxR0hDneJxWj46kkLr8t3DSc1_jRDpY';
    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(
          ...
          seedColor: const Color(0xfffde5c),
        ),
        useMaterial3: true,
      ),
      debugShowCheckedModeBanner: false,
      home: const ChatScreen(title: 'Cooking Chatbot'),
    );
  }
}
...
class _ChatScreenState extends State<ChatScreen> {
  ...
  int _currentIndex = 1; // This will keep track of the current index for the bottom navigation bar.
  ...
  void _onItemTapped(int index) {
    ...
    switch (index) {
      case 0: // Home icon
         Navigator.push(context, MaterialPageRoute(builder: (context) => HomePage())); // Navigate to the ChatPage
              ...
              children: [
                ...
                if (!_loading)
                  IconButton(
                    ...
                    icon: Icon(
                      Icons.send,
                      color: Color.fromARGB(255, 244, 179, 67),
                    ),
                  )
                else
